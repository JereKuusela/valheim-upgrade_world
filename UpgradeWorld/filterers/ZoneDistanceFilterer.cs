...
{
  private Vector2s Center;
  private readonly int MinDistance;
  private readonly int MaxDistance;
  public ZoneDistanceFilterer(Vector2s center, int minDistance, int maxDistance)
  {
    Center = center;
  ...
  private static Vector2s[] FilterByAdjacent(Vector2s[] zones, Vector2s centerZone, int minDistance, int maxDistance)
  {
