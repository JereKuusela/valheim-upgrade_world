...
#nullable restore
  ...
  private static bool CheckIsAvailable()
  {
    ...
    try
    {
      if (probe.Invoke(null, null) is not bool ok || !ok)
        return false;
    }
    catch
    {
  ...
  public static IEnumerator RunCustomPlacement(Dictionary<ZoneSystem.ZoneLocation, int> requests, HashSet<Vector2i> allowedZones)
  {
    ...
    var inner = (IEnumerator)_runCustomPlacementMethod.Invoke(null, [requests, allowedZones, options]);
